        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingFullName = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    ShippingAddress = table.Column<string>(type: "TEXT", maxLength: 240, nullable: false),
                    ShippingCity = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    ShippingPhone = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_ProductId_SessionId",
                table: "CartItems",
